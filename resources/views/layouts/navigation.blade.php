@auth
    <div id="Main"
        ...
        <div class="hidden xl:flex justify-start pt-10 pb-10 items-center space-x-3">
            {{-- {{ dd($user) }} --}}
            <div>
        ...
        <div
            class="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pt-10 pb-10  ">
            <button
